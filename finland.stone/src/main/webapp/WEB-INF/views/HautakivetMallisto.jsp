		...
		<div id="frame">
			<div id="top">
            	<div id="logo">
 				...
 				<div id="head-title">
 					<center><h2><spring:message code="pages.hautakivet.mallisto" /> </h2></center>
 					</br>
 					</br>
 					</br>
 					</br>
 					<center><h4><spring:message code="pages.hautakivet.mallisto.text1" /></h4></center>
 				</div>
			<div ng-repeat="item in headstonesData">
				<div class="col-md-3"  style="border: 2px solid black;border-color:grey" >
