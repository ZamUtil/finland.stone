                            ...
                            <div id="topmenu">
                                <div id="nav">
                                    <ul id="menu">
                                        ...
                                        <li class="current"><a class="active" href="about.html">About</a></li>                                        
					...
					<!-- END OF HEADER -->           
                     ...
                     <div id="content">                     	                   	
                     	<div id="content-inner"> 
                        	<div id="head-top-inner">
                           		<div id="head-title-inner">
                                	<h2>About us</h2><!-- Page title here -->
                            	</div>                            	
                        	</div>                         
                            <div class="maincontent">                            
                          	<p><img src="${pageContext.request.contextPath}/resources/images/pic1.jpg" alt="" class="imgleft-box" />Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae.
                            </p>                            
                            <p>
                            ...
                            <ul class="list">
								<li>Cumque nihil impedit quo minus id quod maxime placeat facere.</li>
								<li>Omnis voluptas assumenda est, omnis dolor repellendus.</li>
								<li>Debitis aut rerum necessitatibus saepe eveniet ut et volup.</li>                                
							</ul>
                        ...
                        <div id="content-right">
                        	<div class="side-box">
                            <h3>More about us</h3>
                            <p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et volup.</p>
                                <ul class="about-list">
                            ...
                            <div class="side-box">
                            <img src="${pageContext.request.contextPath}/resources/images/rss.gif" alt="" class="newsfeed" /><h3>Latest News</h3>
                            <p><strong>6 December 2009</strong><br />
							Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur adipisci velit
                            </p>
                            <p><strong>29 November 2009</strong><br />
							Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae
                            </p>
                            <p><strong>18 November 2009</strong><br />
