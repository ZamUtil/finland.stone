	...
	$(function() {
		$(window).load(function() {
			$('#slide_2').liSlidik({
				...
				duration : 1000
			//Число, определяющие, как долго будет протекать анимация смены слайда (в миллисекундах)
			});
		})
	});
</script>
		...
		<div id="frame">
			<div id="top">
				...
				<div id="topmenu">
					<div id="nav">
						<ul id="menu">
							<li class="current"><a class="active" href="index.html"><spring:message
										code="pages.menu.home" /></a></li>
							<li><a href="Hautakivet.html"><spring:message
			...
			<center>
			<h2>
				<spring:message code="pages.index.title" />
			</h2>
			</center>
			<!-- <div id="head-top1">
                    <div id="head-title">
			...
			<div id="slides_container">
				...
				<div id="slides-text">
					<p>
						<h2>
							<spring:message code="pages.home.about" />
						</h2>
					</p>
					<h4>
						<spring:message code="pages.home.about.text" />
						<br />
					</h4>
					<p>
	...
	<script type="text/ng-template" id="myModalContent.html">
        <div class="modal-header">
   		...
   		<div class="col-sm-12">
			...
			<button class="btn btn-danger btn-lg" ng-click="open()">Kirjoittakaa palaute tähän, kiitos.
			<p>
			<h4>Vastaamme mahdollisimman pian.</h4></button>
</div>
			...
			<div id="content">
				...
				<div id="content2">
					<div class="maincontent">
						<h4>
							<spring:message code="pages.home.services" />
						</h4>

						<img
							src="${pageContext.request.contextPath}/resources/images/services-icon1.png"
							height="58px" weight="58px" alt="" class="img-circle" /> <strong><spring:message
								code="pages.home.services.1" /></strong><br />
						<spring:message code="pages.home.services.1.text" />
						<br />
						<br /> <img
							src="${pageContext.request.contextPath}/resources/images/services-icon2.png"
							height="58px" weight="58px" alt="" class="img-circle" /> <strong><spring:message
								code="pages.home.services.2" /></strong><br />
						<spring:message code="pages.home.services.2.text" />
						<br />
						<br /> <img
							src="${pageContext.request.contextPath}/resources/images/services-icon3.png"
							height="58px" weight="58px" alt="" class="img-circle" /> <strong><spring:message
								code="pages.home.services.3" /></strong><br />
				...
				<div id="content3">
					<div class="maincontent">
						...
						<img
							src="${pageContext.request.contextPath}/resources/images/portfolio-thumb/portfolio_7.jpg"
							class="img-circle">
					</div>
		...
		<div id="footer">
			<div id="foot">
				...
				<div class="right-foot">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
						src="${pageContext.request.contextPath}/resources/images/t.png" alt="" />
